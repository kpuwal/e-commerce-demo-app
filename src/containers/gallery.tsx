      ...
      <div style={{display: 'flex', flexDirection: 'row', width: '400px'}}>
        ...
        <div style={{position: 'relative'}}>
          <div style={{position: 'absolute'}}>
            <img src={this.props.images[0]} alt={'description'} style={{width: '200px', objectFit: 'fill', position:  'absolute', opacity: `${this.state.opacity}`}} />
            <img src={this.state.selectedImage} alt={'description'} style={{width: '200px', objectFit: 'fill', position:  'relative'}} />
          </div>
        </div>
      </div>
    )
